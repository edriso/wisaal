...
export const COPY = {
  ...
  welcomeNew: [
    ...
    '',
    'مرحبًا بك في بوت «وصال». صِلةُ الأرحامِ بابٌ من أبواب الرحمة والمحبة، وفيها بركةٌ في العمر والرزق. يذكّرك هذا البوت بلطف، على الإيقاع الذي تختاره، بأن تَصِل واحدًا من أهلك وأرحامك، واحدًا تلو الآخر، دون أن تنسى أحدًا، بلا أيّ عتاب أو ضغط.',
    '',
  ...
  listEmpty: `لم تُضِف أحدًا بعد. أضِف أول اسم بـ ${ltr('/add')} لتبدأ صِلةَ الأرحامِ.`,
